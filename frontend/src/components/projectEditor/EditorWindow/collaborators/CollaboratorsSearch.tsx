...
const CollaboratorSearch: React.FC<CollaboratorSearchProps> = ({
    ...
    const handleAddCollaborator = useCallback(async (user: MiniUser) => {
            ...
            <CardContent className="p-4 shadow-sm border h-48 overflow-scroll">
                {isLoading ? (
                    ...
                    userSearchResults.map((user) => {
                        ...
                        return (
                            <div key={user._id} className="flex items-center justify-between gap-2 px-4 py-2 bg-muted h-fit mb-2">
                                <MiniUserInfo
